...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from slidesigma.com/themes/html/costic/pages/customer/customerlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Mar 2020 07:37:45 GMT -->
<head>
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Voter List</li>
            </ol>
          </nav>
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              ...
              <table id="data-table-final" class="table w-100 thead-primary">
              	 <thead>
                      <tr>
                    ...
                    <c:forEach var="voter" items="${voterList}">
                     <tr>
                      <td><c:out value="${voter.voterId}" /></td>          
                      <td class="ms-table-f-w"> <img src="/ivote/resources/assets/img/costic/customer-1.jpg" alt="people"><c:out value="${voter.firstName}" /> &nbsp; ${voter.lastName}</td>
                      <td><c:out value="${voter.email}" /></td>
                      <td><c:out value="${voter.niNumber}" /></td>
                      <td><c:out value="${voter.mobileNo}" /></td>
                       <td><c:out value="${voter.address} - ${voter.pincode}" /></td>
                        <td><c:out value="${voter.citizen}" /></td>
                      <td><a href='/ivote/admin/editVoter/${voter.voterId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteVoter/${voter.voterId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                    </tr>
                    </c:forEach>
          		 </tbody>
                  </table>
  ...
  <script src="/ivote/resources/assets/js/slick.min.js">
  </script>
  <script src="/ivote/resources/assets/js/moment.js">
  </script>
  <script src="/ivote/resources/assets/js/jquery.webticker.min.js">
  </script>
  <script src="/ivote/resources/assets/js/Chart.bundle.min.js">
  </script>
  <script src="/ivote/resources/assets/js/Chart.Financial.js">
  </script>
  ...
  var tableOne = $('#data-table-final').DataTable();/*  {
	    //data: dataSet6,
	    columns: [
	      { title: "Product ID" },
	      { title: "Product Name" },
