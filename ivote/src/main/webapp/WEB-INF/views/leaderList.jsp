              	 ...
              	 <thead>
                    ...
                    <tbody>
                     ...
                     <tr>
                      ...
                      <td class="ms-table-f-w"> <img src="/ivote/resources/images/${leader.leaderImage}" alt="people">${leader.firstName} &nbsp; ${leader.firstName}</td>
                      <td>${leader.email}</td>
                      <td>${leader.mobileNo}</td>
                      <td><a href='#'><i class='fas fa-paper-plane text-secondary text-success'></i></a>
                          <a href='/ivote/admin/editLeader/${leader.leaderId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteLeader/${leader.leaderId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                    </tr>
                    </c:forEach>
          		 </tbody>
                  </table>
