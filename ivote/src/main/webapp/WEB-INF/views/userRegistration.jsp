...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from slidesigma.com/themes/html/costic/pages/prebuilt-pages/default-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Mar 2020 07:36:34 GMT -->
<head>
...
<body class="ms-body ms-primary-theme ms-logged-out">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="/ivote/resources/index-2.html"> <img src="/ivote/resources/assets/img/costic/costic-logo-216x62.png" alt="logo"> </a>
    </div>
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
          ...
          <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
              <li> <a href="/ivote/resources/index-2.html">Costic</a> </li>
      ...
      <li class="menu-item">
          ...
          <ul id="product" class="collapse" aria-labelledby="product" data-parent="#side-nav-accordion">
              <li> <a href="../product/productcata.html">Menu Catalogue</a> </li>
                    <li> <a href="../product/productlist.html">Menu List</a> </li>
                          <li> <a href="../product/productgrid.html">Menu Grid</a> </li>
            ...
            <li class="menu-item">
                ...
                <ul id="customer" class="collapse" aria-labelledby="customer" data-parent="#side-nav-accordion">
                    <li> <a href="../customer/customersreview.html">Customers Review</a> </li>
                          ...
                          <li> <a href="../customer/social.html">Social Activity</a> </li>
  ...
  <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="/ivote/resources/index-2.html"><img src="/ivote/resources/assets/img/costic/costic-logo-84x41.png" alt="logo"> </a>
      </div>
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        ...
        <li class="ms-nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="mailDropdown">
            ...
            <li class="ms-scrollable ms-dropdown-list">
              ...
              <a class="media p-2" href="#">
                <div class="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
                  <img src="/ivote/resources/assets/img/costic/customer-3.jpg" class="ms-img-round" alt="people">
                </div>
                <div class="media-body">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="ms-user-img ms-img-round float-right" src="/ivote/resources/assets/img/costic/customer-6.jpg" alt="people"> </a>
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            ...
            <li class="ms-dropdown-list">
              <a class="media fs-14 p-2" href="user-profile.html"> <span><i class="flaticon-user mr-2"></i> Profile</span> </a>
              ...
              <a class="media fs-14 p-2" href="user-profile.html"> <span><i class="flaticon-gear mr-2"></i> Account Settings</span> </a>
            </li>
            <li class="dropdown-divider"></li>
            <li class="dropdown-menu-footer">
              <a class="media fs-14 p-2" href="lock-screen.html"> <span><i class="flaticon-security mr-2"></i> Lock</span> </a>
            </li>
            <li class="dropdown-menu-footer">
              <a class="media fs-14 p-2" href="default-login.html"> <span><i class="flaticon-shut-down mr-2"></i> Logout</span> </a>
            </li>
          </ul>
        </li>
      </ul>
            ...
            <form:form class="needs-validation" action="/ivote/admin/voterRegistration"
              ...
              <div class="form-row">
                <div class="col-md-6 ">
                  ...
                  <div class="input-group">
                    <form:input class="form-control" type="text" id="firstName" name="firstName" path="firstName" placeholder="first name" />
                ...
                <div class="col-md-6 ">
                  ...
                  <div class="input-group">
                    <form:input class="form-control" type="text" id="lastName" name="lastName" path="lastName" placeholder="last name" />
                     <div class="valid-feedback">
                      Looks good!
                    </div>
                  </div>
              ...
              <div class="form-row">
                <div class="col-md-6 ">
                  ...
                  <div class="input-group">
                    <form:input class="form-control" type="text" id="email" name="email" path="email" placeholder="test@gmail.com" aria-describedby="inputGroupPrepend" />
                      <div class="valid-feedback">
                      Looks good!
                    </div>
                  </div>
                ...
                <div class="col-md-6 ">
                  <label for="validationCustom02">NI number</label>
                  <div class="input-group">
                    <form:input class="form-control" type="text" id="niNumber" name="niNumber" path="niNumber" placeholder="NI number" />
                      <div class="valid-feedback">
                      Looks good!
                    </div>
                  </div>
              ...
              <div class="form-row">
                <div class="col-md-6 ">
                  ...
                  <div class="input-group">
                    <form:input class="form-control" type="text" id="pincode" name="pincode" path="pincode" placeholder="pincode" />
                      <div class="valid-feedback">
                      Looks good!
                    </div>
                  </div>
                ...
                <div class="col-md-6 ">
                  ...
                  <div class="input-group">
                    <form:input class="form-control" type="text" id="address" name="address" path="address" placeholder="house no" />
                      <div class="valid-feedback">
                      Looks good!
                    </div>
                  </div>
                ...
                <div class="col-md-12 ">
                <label for="exampleSelect">Citizen</label>
				  <form:select class="custom-select" path="citizen">
  ...
  <script src="/ivote/resources/assets/js/perfect-scrollbar.js"> </script>
