        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item"><a href="#">Nations</a>
              </li>
            </ol>
          </nav>
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              <form:form class="needs-validation" action="/ivote/admin/addNation"
							modelAttribute="nations" method="post">
				<form:hidden class="form-control" id="nationId" name="nationId" path="nationId"/>
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    <label for="validationCustom18">Nations Name</label>
                    <div class="input-group">
                      <form:input class="form-control" type="text" id="nationName" name="nationName" path="nationName" placeholder="nations name" />
      ...
      <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              ...
              <table id="data-table-final1" class="table w-100 thead-primary">
              	 <thead>
                      <tr>
                        <th scope="col">Nations ID</th>
                        <th scope="col">Nations Name</th>
                        <th scope="col">Send / Edit / Delete</th>
                      </tr>
                    </thead>
                    <tbody>
                     <c:forEach var="nation" items="${nationsList}">
                     <tr>
                      	<td><c:out value="${nation.nationId}" /></td>          
                      	<td><c:out value="${nation.nationName}" /></td>
                      	<td><a href='/ivote/admin/editNation/${nation.nationId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteNation/${nation.nationId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                   	</tr>
                    </c:forEach>
          		 </tbody>
                  </table>
