        ...
        <div class="col-md-12">
          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              <form:form class="needs-validation clearfix" action="/ivote/admin/addLeader"
							modelAttribute="leader" method="post" enctype="multipart/form-data">
                <div class="form-row">
                	<form:hidden class="form-control" id="leaderId" name="leaderId" path="leaderId"/>
                  ...
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom12">Leader Image</label>
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="validatedCustomFile" name="leaderImage">
