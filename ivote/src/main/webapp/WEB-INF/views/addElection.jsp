        ...
        <div class="col-md-12">
          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              <form:form class="needs-validation clearfix" action="/ivote/admin/addElection"
							modelAttribute="election" method="post" enctype="multipart/form-data">
                <div class="form-row">
                	<form:hidden class="form-control" id="electionId" name="electionId" path="electionId"/>
                  <div class="col-md-6 mb-3">
                    <label for="validationCustom18">Election Name</label>
                    <div class="input-group">
                      <form:input class="form-control" type="text" id="electionName" name="electionName" path="electionName" placeholder="Election Name" />
                  ...
                  <div class="col-md-6 mb-3">
                  <label for="exampleSelect">Election DateTime</label>
				  <div class="input-group">
                      <form:input class="form-control" type="text" id="electionDateTime" name="electionDateTime" path="electionDateTime" placeholder="Election DateTime" />
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                    	<form:textarea rows="5" class="form-control" type="text" id="electionDesc" name="electionDesc" path="electionDesc" placeholder="SubMenu Description" />
                  ...
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom12">Election Image</label>
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="validatedCustomFile" name="electionImage">
