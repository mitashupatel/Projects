              ...
              <table id="data-table-final" class="table w-100 thead-primary">
              	 <thead>
                    ...
                    <tbody>
                     ...
                     <tr>
                      <td>${mp.mpId}</td>          
                      <td class="ms-table-f-w"> <img src="/ivote/resources/images/${mp.mpImage}" alt="people">${mp.firstName} &nbsp; ${mp.lastName}</td>
                      <td>${mp.email}</td>
                      <td>${mp.mobileNo}</td>
                      <td><a href='#'><i class='fas fa-paper-plane text-secondary text-success'></i></a>
                          <a href='/ivote/admin/editMP/${mp.mpId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteMP/${mp.mpId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                    </tr>
                    </c:forEach>
          		 </tbody>
                  </table>
