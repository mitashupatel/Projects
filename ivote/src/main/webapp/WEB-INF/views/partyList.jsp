              ...
              <table id="data-table-final" class="table w-100 thead-primary">
              	 <thead>
                    ...
                    <tbody>
                     ...
                     <tr>
                      <td>${party.partyId}</td>          
                      <td class="ms-table-f-w"> <img src="/ivote/resources/images/${party.partyImage}" alt="people">${party.partyName}</td>
                      <td>${party.partyDesc}</td>
                      <td class="ms-table-f-w"> <img src="/ivote/resources/images/${party.leaderImage}" alt="people">${party.leaderFirstName} &nbsp; ${party.leaderLastName}</td>
                      <td><a href='#'><i class='fas fa-paper-plane text-secondary text-success'></i></a>
                          <a href='/ivote/admin/editParty/${party.partyId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteParty/${party.partyId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                    </tr>
                    </c:forEach>
          		 </tbody>
                  </table>
