        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">MP List</li>
            </ol>
          </nav>
          <div class="ms-panel">
              ...
              <table id="data-table-final" class="table w-100 thead-primary">
              	 <thead>
                    ...
                    <tbody>
                     ...
                     <tr>
                      <td>${mp.mpId}</td>          
                      <td class="ms-table-f-w"> <img src="/ivote/resources/images/${mp.mpImage}" alt="people">${mp.mpFirstName} &nbsp; ${mp.mpLastName}</td>
                      <td class="ms-table-f-w"> <img src="/ivote/resources/images/${mp.leaderImage}" alt="people">${mp.leaderFirstName} &nbsp; ${mp.leaderLastName}</td>
                      <td class="ms-table-f-w"> <img src="/ivote/resources/images/${mp.partyImage}" alt="people">${mp.partyName}</td>
                      <td><a onclick="javascript:MyFunction(${mp.mpId},${mp.voterId},${mp.electionId},${mp.partyId} )"><i class='fas fa-paper-plane text-secondary text-success'></i></a>
