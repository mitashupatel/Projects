        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Election List</li>
            </ol>
          </nav>
          <div class="ms-panel">
              ...
              <table id="data-table-final" class="table w-100 thead-primary">
              	 <thead>
                      <tr>
                        ...
                        <th scope="col">Election DateTime</th>
                        <th scope="col">Election desc</th>
                    ...
                    <tbody>
                     ...
                     <tr>
                      ...
                      <td class="ms-table-f-w"> <img src="/ivote/resources/images/${election.electionImage}" alt="people">${election.electionName}</td>
                      <td>${election.electionDateTime}</td>
                      <td>${election.electionDesc}</td>
                      <td><a href='#'><i class='fas fa-paper-plane text-secondary text-success'></i></a>
                          <a href='/ivote/admin/editElection/${election.electionId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteElection/${election.electionId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                    </tr>
                    </c:forEach>
          		 </tbody>
                  </table>
