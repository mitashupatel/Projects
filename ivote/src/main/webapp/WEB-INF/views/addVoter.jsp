        ...
        <div class="col-md-12">
          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
                <form:form class="needs-validation" action="/ivote/admin/addVoter"
                ...
                <form:hidden class="form-control" id="voterId" name="voterId" path="voterId"/>
                  ...
                  <div class="col-md-4 mb-3">
                    <label for="validationCustom01">NI number</label>
                    <div class="input-group">
                      <form:input class="form-control" type="text" id="niNumber" name="niNumber" path="niNumber" placeholder="first name" />
                      <div class="valid-feedback">Looks good!</div>
                    </div>
                  </div>
                  <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                      <form:input class="form-control" type="text" id="mobileNo" name="mobileNo" path="mobileNo" placeholder="last name" />
                      <div class="valid-feedback">Looks good!</div>
                    </div>
                  </div>
                  <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                      <form:input class="form-control" type="text" id="address" name="address" path="address" placeholder="address" />
                      <div class="valid-feedback">Looks good!</div>
                    </div>
                  </div>
                  <div class="col-md-4 mb-3">
