...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from slidesigma.com/themes/html/costic/pages/prebuilt-pages/default-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Mar 2020 07:36:34 GMT -->
<head>
      ...
      <div class="ms-auth-container">
        ...
        <div class="ms-auth-col">
          <div class="ms-auth-form">
           <form:form class="needs-validation" action="/ivote/user/userLoggingIn"
              ...
              <%} %>
              <div class="mb-3">
                <label for="validationCustom08">NI Number</label>
                <div class="input-group">
                  <input type="text" class="form-control" name="niNumber" id="validationCustom08" placeholder="NI number" required="">
              ...
              <p class="mb-0 mt-3 text-center">Don't have an account? <a class="btn-link" href="/ivote/admin/voterRegistrationPage">Create Account</a> 
              </p>
            </form:form>
          </div>
        </div>
