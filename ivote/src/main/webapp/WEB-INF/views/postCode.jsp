        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item"><a href="#">Constituencies</a>
              </li>
            </ol>
          </nav>
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              <form:form class="needs-validation" action="/ivote/admin/addPostCode"
							modelAttribute="postcode" method="post">
				<form:hidden class="form-control" id="postCodeId" name="postCodeId" path="postCodeId"/>
                <div class="form-row">
                  ...
                  <div class="col-md-6 mb-3">
                    <label for="validationCustom18">Postcode</label>
                    <div class="input-group">
                      <form:input class="form-control" type="text" id="postCodeName" name="postCodeName" path="postCodeName" placeholder="postcode name" />
      ...
      <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              ...
              <table id="data-table-final1" class="table w-100 thead-primary">
              	 <thead>
                      <tr>
                        <th scope="col">Postcode ID</th>
                        <th scope="col">Postcode Name</th>
                    ...
                    <tbody>
                     ...
                     <tr>
                      	<td><c:out value="${postcode.postCodeId}" /></td>
                      	<td><c:out value="${postcode.postCodeName}" /></td> 
                      	<td><c:out value="${postcode.constituencyName}" /></td>         
                      	<td><c:out value="${postcode.regionName}" /></td>
                      	<td><c:out value="${postcode.nationName}" /></td>
                      	<td><a href='/ivote/admin/editPostcode/${postcode.postCodeId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deletePostcode/${postcode.postCodeId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                   	</tr>
                    </c:forEach>
          		 </tbody>
                  </table>
  	...
  	$("#nationId").change(function() {
  	    ...
  	    $.ajax({
  	        ...
  	        success: function(data){
  	            ...
  	            slctSubcat.empty();
				var select = "<option value='0'> --- Select region ---</option>";
