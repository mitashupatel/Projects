        ...
        <div class="col-md-12">
          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              <form:form class="needs-validation" action="/ivote/user/voteResult"
							modelAttribute="vote" method="post">
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                  <label for="exampleSelect">Election</label>
				  <form:select class="custom-select" path="electionId">
              ...
              <table id="data-table-final1" class="table w-100 thead-primary">
              	 <thead>
                    ...
                    <tbody>
                     ...
                     <tr>
                      	<td><c:out value="${vote.partyId}" /></td>          
                      	<td class="ms-table-f-w"> <img src="/ivote/resources/images/${vote.partyImage}" alt="people">${vote.partyName}</td>
                      	<td><c:out value="${vote.voteCount}" /></td>
