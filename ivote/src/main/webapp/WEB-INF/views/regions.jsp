        ...
        <div class="col-md-12">
          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              <form:form class="needs-validation" action="/ivote/admin/addRegions"
							modelAttribute="regions" method="post">
				<form:hidden class="form-control" id="regionId" name="regionId" path="regionId"/>
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                  <label for="exampleSelect">Nation Name</label>
				  <form:select class="custom-select" path="nationId">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <form:input class="form-control" type="text" id="regionName" name="regionName" path="regionName" placeholder="region name" />
              	 ...
              	 <thead>
                    ...
                    <tbody>
                     ...
                     <tr>
                      	...
                      	<td><c:out value="${region.nationName}" /></td>
                      	<td><a href='/ivote/admin/editRegions/${region.regionId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteRegions/${region.regionId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                   	</tr>
                    </c:forEach>
          		 </tbody>
                  </table>
