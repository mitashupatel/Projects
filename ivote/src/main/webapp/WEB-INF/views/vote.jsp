        ...
        <div class="col-md-12">
          ...
          <div class="ms-panel">
            <div class="ms-panel-header">
              <h6>Add Constituencies</h6>
            </div>
            <div class="ms-panel-body">
              <form:form class="needs-validation" action="/ivote/admin/addMapping"
							modelAttribute="constituency" method="post">
				<form:hidden class="form-control" id="constituencyId" name="constituencyId" path="constituencyId"/>
                <div class="form-row">
                <div class="col-md-4 mb-3">
                  <label for="exampleSelect">Election Name</label>
				  <form:select id="electionId" class="custom-select" path="electionId">
                         <c:forEach items="${electionList}" var="nation">
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <form:select class="custom-select" id="" path="mpId">
                         <c:forEach items="${mpList}" var="mp">
                           <form:option value="${mp.mpId}">${mp.mpName}</form:option>
                        </c:forEach>
                  </form:select>
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <form:input class="form-control" type="text" id="constituencyName" name="constituencyName" path="constituencyName" placeholder="constituency name" />
              ...
              <table id="data-table-final1" class="table w-100 thead-primary">
              	 <thead>
                    ...
                    <tbody>
                     ...
                     <%-- <tr>
                      	<td><c:out value="${constituency.constituencyId}" /></td> 
                      	<td><c:out value="${constituency.constituencyName}" /></td>         
                      	<td><c:out value="${constituency.regionName}" /></td>
                      	<td><c:out value="${constituency.nationName}" /></td>
                      	<td><a href='/ivote/admin/editConstituency/${constituency.constituencyId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteConstituency/${constituency.constituencyId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                   	</tr> --%>
                   	<tr>
                      	<td>1</td> 
                      	<td>2</td>         
                      	<td>3</td>
                      	<td>4</td>
                      	<td><a href='/ivote/admin/editConstituency/1'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteConstituency/1'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                   	</tr>
                    </c:forEach>
          		 </tbody>
                  </table>
