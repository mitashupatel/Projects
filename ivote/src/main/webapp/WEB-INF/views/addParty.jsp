        ...
        <div class="col-md-12">
          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              <form:form class="needs-validation clearfix" action="/ivote/admin/addParty"
							modelAttribute="party" method="post" enctype="multipart/form-data">
                <div class="form-row">
                	<form:hidden class="form-control" id="partyId" name="partyId" path="partyId"/>
                  <div class="col-md-6 mb-3">
                    <label for="validationCustom18">Party Name</label>
                    <div class="input-group">
                      <form:input class="form-control" type="text" id="partyName" name="partyName" path="partyName" placeholder="Party Name" />
                  ...
                  <div class="col-md-6 mb-3">
                    <label for="validationCustom18">Leader</label>
                    <form:select class="custom-select" id="" path="leaderId">
                         <c:forEach items="${leaderList}" var="leader">
                           <form:option value="${leader.leaderId}">${leader.firstName} &nbsp; ${leader.lastName}</form:option>
                        </c:forEach>
                  </form:select>
                  </div>
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                    	<form:textarea rows="5" class="form-control" type="text" id="partyDesc" name="partyDesc" path="partyDesc" placeholder="SubMenu Description" />
                  ...
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom12">Party Image</label>
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="validatedCustomFile" name="partyImage">
