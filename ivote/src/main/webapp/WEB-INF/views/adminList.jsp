              	 ...
              	 <thead>
                    ...
                    <c:forEach var="admin" items="${adminList}">
                     <tr>
                      ...
                      <td class="ms-table-f-w"> <img src="/ivote/resources/assets/img/costic/customer-1.jpg" alt="people"><c:out value="${admin.firstName}" /> &nbsp; ${admin.lastName}</td>
                      <td><c:out value="${admin.email}" /></td>
                      <td><c:out value="${admin.mobileNo}" /></td>
                      <td><a href='/ivote/admin/editAdmin/${admin.adminId}'><i class='fas fa-pencil-alt text-secondary'></i></a>
                          <a href='/ivote/admin/deleteAdmin/${admin.adminId}'><i class='far fa-trash-alt ms-text-danger'></i></a></td>
                    </tr>
                    </c:forEach>
          		 </tbody>
                  </table>
