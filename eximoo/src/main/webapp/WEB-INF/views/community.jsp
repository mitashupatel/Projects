            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-8">
                        ...
                        <h2 class="blog-details__content-title text-sm-center">Community Forum</h2><!-- /.blog-details__content-title -->
                        <div class="comment-one">
                            <div class="comment-one__single">
                                <div class="comment-one__image">
                                    <div class="inner-block">
                                        <img src="/eximoo/resources/assets/images/comment-1-1.jpg" alt="Awesome Image" />
                                    </div><!-- /.inner-block -->
                                </div><!-- /.comment-one__image -->
                                <div class="comment-one__content">
                                    <div class="comment-one__content-top">
                                        <div class="comment-one__top-left">
                                            <h3 class="comment-one__author">Mitashu Patel</h3>
                                            <!-- /.comment-one__author -->
                                            <p class="comment-one__date">15 July, 2020 <span class="comment-one__date-sep">-</span> 4:00 pm</p>
                                            <!-- /.comment-one__date -->
                                            <p class="comment-one__text">Hey This Is Awsome Website And Graphic of this design is very good. A</p>
                                            <!-- /.comment-one__text -->
                            ...
                            <div class="comment-one__single">
                                <div class="comment-one__image">
                                    <div class="inner-block">
                                        <img src="/eximoo/resources/assets/images/comment-1-2.jpg" alt="Awesome Image" />
                                    </div><!-- /.inner-block -->
                                </div><!-- /.comment-one__image -->
                                <div class="comment-one__content">
                                    <div class="comment-one__content-top">
