          ...
          <div class="col-sm-12">
            ...
            <c:forEach var="lang" items="${languageList}">
                <tr>
                    ...
                    <td>
                        <a href="/eximoo/admin/editLanguage/${lang.languageId}"><i class="fas fa-pen-square"></i></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/eximoo/admin/deleteLanguage/${lang.languageId}"><i class="fas fa-trash"></i></a>                     
                    </td>
