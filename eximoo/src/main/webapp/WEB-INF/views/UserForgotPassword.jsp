	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form:form class="login100-form validate-form" action="/eximoo/user/forgettingpassword"
							modelAttribute="password" method="post">
							<Center><h3>Forgot Password</h3>
              <p>Please enter your Registered Email to continue</p></Center>
           
				
				
					<div class="wrap-input100 validate-input m-b-26" data-validate="Email is required">
						<span class="label-input100">Email</span>
						<form:input class="input100" path="email" id="email" type="email" name="email" placeholder="Enter email"/>
