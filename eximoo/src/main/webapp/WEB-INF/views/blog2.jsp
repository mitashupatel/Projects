...
<%@ include file="header.jsp" %>
	<!-- Main Wrapper Div -->
	<div class="container-fluid topbar-one ">
	<div class="row row justify-content-center">
	<ul class="nav">
	<c:forEach var="lang" items="${languageList}" >
  <li class="nav-item" >
    <a class="nav-link active hello" href="#">${lang.language}</a>
  </li>
  <!-- <li class="nav-item">
    <a class="nav-link hello" href="#">Python</a>
  </li>
  <li class="nav-item">
    <a class="nav-link hello" href="#">HTML</a>
  </li> 
  <li class="nav-item">
    <a class="nav-link hello" href="#">CSS</a>
  </li><li class="nav-item">
    <a class="nav-link hello" href="#">JAVASCRIPT</a>
  </li><li class="nav-item">
    <a class="nav-link hello" href="#">ANGULAR</a>
  </li><li class="nav-item">
    <a class="nav-link hello" href="#">NODE JS</a>
  </li> -->
  </c:forEach>
</ul>
	</div>
    ...
    <section class="page-conents"> 
		<div class="container">
				<div class="row">
			            ...
			            <p>
			              <img src="/eximoo/resources/assets/images/aboutcircle.jpg" alt="" class="img-fluid">
			            </p>
