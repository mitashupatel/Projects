	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form:form class="login100-form validate-form" action="/eximoo/user/changingPassword"
							modelAttribute="cpassword" method="post">
							<Center><h3>Change Password</h3>
              <p>Please enter your Credentials to continue</p></Center>
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Old Password is required">
						...
						<form:input class="input100" path="password" id="password" type="password" name="password" placeholder="Enter Password"/>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<form:input class="input100" path="npassword" id="npassword" type="password" name="npassword" placeholder="Enter New Password"/>
